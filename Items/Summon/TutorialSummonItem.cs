...
namespace TutorialMod.Items.Summon
{
    public class TutorialSummonItem : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Tutorial Summon");
            Tooltip.SetDefault("Summons the Frozen Eye Tutorial Boss");
        }
