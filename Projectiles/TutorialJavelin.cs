...
namespace TutorialMod.Projectiles
{
    public class TutorialJavelin : ModProjectile
    {
        ...
        public override void Kill(int timeLeft)
        {
            ...
            int item = 0;
            if(Main.rand.NextFloat() < 0.18f) // This handles the rate at which the new item will drop. 0.99f == highChance
            {
                // This will spawn a javelin drop at position of javelin and in the space of the hitbox
                item = Item.NewItem((int)projectile.position.X, (int)projectile.position.Y, projectile.width, projectile.height, mod.ItemType<Items.Weapons.TutorialJavelin>(), 1, false, 0, false, false);
            }
